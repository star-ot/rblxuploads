...
export const CONFIG_STORAGE_KEY = "starvsk-rblx-uploader-config-v5";

/** Previous key — read once for migration, never written again. */
export const LEGACY_CONFIG_STORAGE_KEY = "starvsk-rblx-uploader-config-v4";

/** v3 plaintext config — migrated through v4 reader when present. */
export const LEGACY_V3_CONFIG_STORAGE_KEY = "starvsk-rblx-uploader-config-v3";
